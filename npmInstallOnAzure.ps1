...
Write-Output "If error occurs, ensure FTP credentials are set in web app."
...
Write-Output "Invoking 'npm install http express path file-system dotenv' on $AppServiceName ..."
